...
import ResolutionCertificatePage from "../views/resolution-certificate";
import MDDetailsFormPreview from "../views/md-details-page/mdDetails-form-preview/MdDetailsFormPreview";
...
const AppRouters: FC = () => {
  return (
    <Routes>
      ...
      <Route path={`/md-details/:mdId`} element={<MDDetailsFormPreview />} />
      ...
      <Route path={`/board-resolution/:resolutionId`} element={<ResolutionCertificatePage />} />
