...
const FarmersDetailsModal = (props: CommonModalProps) => {
  return (
    <>
      <CommonIconModal open={props.open} handleClose={props.handleClose} generateIdCard={props.generateIdCard} generateFarmerDetailForm={props.generateFarmerDetailForm}>
