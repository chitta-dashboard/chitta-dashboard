...
const initialState: mdDetailsContextType = {
  ...
  mdDetailsById: {
    "2": {
      id: "2",
      fatherName: "NAYAGAM",
      spouseName: "Testing data",
      // spouseName: "",
      phoneNumber: "9489585953",
      addhaarNo: "994450741979",
      dob: "21-10-1973",
      sex: "male",
      address: "RAMARAJAPURAM ROAD",
      village: "VIRIYUR",
      taluk: "SANKARAPURAM",
      district: "KALLAKURICHI",
      postalNo: "606402",
      surveyNo: { "surveyNo-first": "132/8", "surveyNo-second": "42/4A" },
      landType: "option-2",
      // landType: "WET LAND",
      membershipId: "NER-FPC-2",
      name: "SAVARIYAPPAN N\n",
      ...
      //border:"",
      farmerType: "option-2",
      // cropsType: 'SUGAR CANE',
      waterType: "option-2",
      // irrigationType: 'TRIP IRRIGATION',
      animals: "NIL",
      // cattle: 'NIL',
      groupMember: "yes",
      acre: { "acre-first": "1", "acre-second": "1" },
      // landAreaInCent: "63",
      qualification: "B.E, Mechanical",
      // qualification: "",
      // smallOrMarginalFarmer: 'SMALL',
      farmerId:"2"
    },
  },
  searchFilter: "",
